    ...
    <header className="h-16 bg-white border-b border-gray-100 flex items-center px-4 sm:px-6 gap-3 sticky top-0 z-20 flex-shrink-0">
      ...
      <div className="flex items-center gap-2 sm:gap-2.5">
        ...
        <button className="hidden sm:flex items-center gap-2 h-8 px-3 rounded-lg border border-gray-200 bg-gray-50 text-[12px] font-semibold text-gray-600 hover:bg-gray-100 hover:border-gray-300 hover:text-gray-800 active:scale-[0.97] transition-all duration-150 select-none">
          ...
          <span className="hidden md:block">May 20 – May 26, 2026</span>
          <span className="block md:hidden">May 20–26</span>
        ...
        {/* Add New Unit CTA */}
        <Button size="sm" className="hidden lg:flex h-8 text-[12px] px-3 gap-1.5">
